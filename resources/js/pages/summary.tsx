...
const Checkout = ({ cartItems }: CartItemsProps) => {
    ...
    const decreaseFromCart = (foodItem: CartItem) => {
        router.visit('/cartSummary', {
            method: 'patch',
            data: {
                product: foodItem,
    ...
    return (
        <div className="mb-10 px-4 pt-24 md:px-12 lg:px-24">
            ...
            {cartItems.length === 0 ? (
                ...
                <div className="space-y-6">
                                    ...
                                    <div className="flex-1 md:ml-4">
                                        ...
                                        <div className="flex flex-row space-x-4">
                                            ...
                                            <div className="mt-2 flex flex-row space-x-3">
                                                <button onClick={() => decreaseFromCart(item)} className="cursor-pointer">
                                                    -
                                                </button>
                    ...
                    <div className="mt-8 text-right">
                        <h2 className="mb-8 text-xl font-bold">Cart Total: ${calculateCartTotal()}</h2>
                        <a
                            href="/order"
                            className="my-2 rounded border-2 border-black px-5 py-2 text-xl font-extrabold text-black hover:cursor-pointer hover:bg-black hover:text-[#FFF9EA]"
                        >
                            Order
                        </a>
                    </div>
...
Checkout.layout = (page: ReactNode) => <Layout children={page} />;
